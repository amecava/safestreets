...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{old-diagrams/useCase}
	\caption{
		\label{fig:useCase} 
		Use case diagram
	}
...
\begin{figure}[h!]
	\centering
	\includegraphics [width=\textwidth]{old-diagrams/Sequence/sdRegistration.png}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics [width=\textwidth]{old-diagrams/Sequence/sdLogin.png}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics [width=\textwidth]{old-diagrams/Sequence/sdCarMapVisualization.png}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics [width=\textwidth]{old-diagrams/Sequence/sdCarUnlock.png}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics [width=\textwidth]{old-diagrams/Sequence/sdCarRent}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics [width=\textwidth]{old-diagrams/Sequence/sdOneEuroFee}
	\caption{
...
The overall status of a car can be represented by the FSM in \autoref{fig:carFSA}
	\begin{figure}[h]
			\centering
			\includegraphics[scale=0.5]{old-diagrams/CarFSA}
			\caption{
				\label{fig:carFSA} 
				Car status FSM
			}
...
\begin{figure}[h!]
	\centering
	\includegraphics [width=\textwidth]{old-diagrams/Sequence/sdRentPayment}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics [width=\textwidth]{old-diagrams/Sequence/sdMoneySavingOption}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics [width=\textwidth]{old-diagrams/Sequence/sdViewNotAvaCars}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics [width=\textwidth]{old-diagrams/Sequence/sdTagCarAva}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics [width=\textwidth]{old-diagrams/Sequence/sdTagCarNotAva}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics [width=\textwidth]{old-diagrams/ClassDiagram}
	\caption{
