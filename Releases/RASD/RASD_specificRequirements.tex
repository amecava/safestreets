...
\paragraph{Municipality Data Exchange} Since Municipality's service 	is an external component of our system, will be described based on the functionalities it will be required to offer, namely:
	...
	The system will use Municipality's service to offer the users the possibility to retrieve the information about the accidents that occur on the territory of the municipality. Furthermore, as already stated, we will cross our data with theirs to offer statistics about

	\begin{figure}[h]
		\centering
		\includegraphics[width=320pt]{diagrams/systemInterfaces.png}
		\caption{
