...
\paragraph{Municipality Data Exchange} The definition of the municipality data exchange interface is dependent to the corresponding SafeStreet's interface required to be offered to the municipalities. The municipality is required to offer the following functionalities to the system:
	...
	\begin{itemize}
		...
		\item provide a secure transfer of data regarding the accidents occurred in the territory of the municipality
		\item provide a secure transfer of data regarding the issued tickets
	\end{itemize} 
	...
	\begin{itemize}
		...
		\item provide a secure transfer of data regarding the user uploaded violations
		\item provide a secure transfer of data regarding the possible interventions suggestions 
