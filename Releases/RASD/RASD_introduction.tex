...
\subsubsection{Goals}
	...
	\begin{enumerate}[label=\textbf{G\arabic*}]
		...
		\item \label{goal:consultMap} Allow users to consult a map showing unsafe areas and view statistics about previously submitted violations
		\item \label{retrieveData} Allow municipality to retrieve violation data using a restrict access API provided to them
...
\subsection{Glossary}
	...
	\begin{description}
		...
		\item[Local authorities \emph{or}:] the local authorities of the municipality for example the local police
