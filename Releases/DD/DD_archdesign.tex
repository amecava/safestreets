...
\begin{figure}[h]
	\centering
	\includegraphics[width=\linewidth]{ServerComponent}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{MapHandlerComponent}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{SubmissionHandlerComponent}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{AccessHandlerComponent}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{APIHandlerComponent}
	\caption{
...
\begin{figure}[h]
			\centering
			\includegraphics[angle=0,width=0.9685\linewidth]{deployComponent}
			\caption{
...
\paragraph{Notes to read the diagram} When an attribute is modified in a JPA object the changes are reflected into the
	\emph{DataProviderComponent} in order to keep the database updated. \todo{What does this mean?}
...
\subsubsection{Upload}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[angle=0,width=\linewidth]{sequenceDiagrams/uploadSubmission}
		\caption{
...
\begin{figure}[h!]  
	\centering
	\includegraphics[angle=0,width=0.75\linewidth]{sequenceDiagrams/mapRequest}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics[angle=0,width=0.95\linewidth]{sequenceDiagrams/showStatistics}
	\caption{
